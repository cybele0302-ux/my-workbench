...
const APP_VERSION = 'wobench-v28.7';
    ...
    const JINGWEN = {
      daodejing: [
        ...
        { title: '道可道', chapter: '第一章', source: '《道德经》', text: '道可道，非常道；名可名，非常名。', explain: '真正的道无法用语言完全定义，真正的名也无法用概念完全框定。重要的不是言辞，而是体悟；重要的不是标签，而是那个被指代的存在本身。读经典，重在以心印证，而非执著名相。' },
        { title: '功成不居', chapter: '第二章', source: '《道德经》', text: '功成而弗居，夫唯弗居，是以不去。', explain: '成就了事业却不居功，正因为不居功，反而其功得以长存。谦退不是软弱，而是让自己持续被需要的人格智慧。越是不把功劳揽在自己身上的人，越能持续做出贡献。' },
        { title: '天长地久', chapter: '第七章', source: '《道德经》', text: '天长地久。天地所以能长且久者，以其不自生，故能长生。', explain: '天地之所以长久，正因它们不为自己而生存。一个人若能放下对自我的执着计较，反而能在时间中留下更深的痕迹。无私者最长久。' },
        { title: '载营魄抱一', chapter: '第十章', source: '《道德经》', text: '载营魄抱一，能无离乎？', explain: '身体与精神合一而不分离，这是修身的总纲。现代人之所以疲惫，是因为身体在工作、心却在别处；身心合一，是把心安住于此刻所做的事。' },
        { title: '三十辐共一毂', chapter: '第十一章', source: '《道德经》', text: '三十辐共一毂，当其无，有车之用。', explain: '三十根辐条汇聚于一个空心的毂，正是因为"无"，才成就了"有"的功用。空间比填充更重要，留白比堆砌更智慧。留一点余地，留一点空白，反而让一切运转起来。' },
        { title: '五色令人目盲', chapter: '第十二章', source: '《道德经》', text: '五色令人目盲，五音令人耳聋，五味令人口爽。', explain: '过度的感官刺激反而让感官麻木。真正的享受不在多与浓，而在少与清。减少输入、减少刺激，反而能让感受力恢复敏锐。' },
        { title: '宠辱若惊', chapter: '第十三章', source: '《道德经》', text: '宠辱若惊，贵大患若身。', explain: '得宠与受辱都让人惊慌，是因为把"身外之名"看得比"自身"还重。轻看外在的得失，就是把生命的重心放回自己身上。' },
        { title: '视之不见', chapter: '第十四章', source: '《道德经》', text: '视之不见，名曰夷；听之不闻，名曰希；搏之不得，名曰微。', explain: '道超越了视觉、听觉、触觉的一切边界。它无法被感官捕捉，只能被心灵领悟。这是为什么真正的智慧不是学来的，而是在静默中显现的。' },
        { title: '太上不知有之', chapter: '第十七章', source: '《道德经》', text: '太上，不知有之；其次，亲而誉之；其次畏之，其次侮之。', explain: '最好的领导者，人民不知道他的存在。最高的治理，是让人感觉不到约束与引导。无为而无不为——不刻意、不彰显，反而是最好的成就。' },
        { title: '大道废有仁义', chapter: '第十八章', source: '《道德经》', text: '大道废，有仁义；智慧出，有大伪。', explain: '当大道被遗忘，仁义的口号才会被高声提倡；当机巧被推崇，巨大的虚伪便随之而来。这是对一切"口号大于实践"的精准批判——越是呼唤某种美德，往往越是缺失。' },
        { title: '见素抱朴', chapter: '第十九章', source: '《道德经》', text: '见素抱朴，少私寡欲。', explain: '保持本色的朴素，减少私心与欲望。简单不是贫穷，而是对生命本质的回归。当我们不被外在的繁复所裹挟，内心才得以清明。' },
        { title: '唯之与阿', chapter: '第二十章', source: '《道德经》', text: '唯之与阿，相去几何？', explain: '应诺与呵斥相差多远？看似对立，其实在情绪深处相连。世间许多相反之物其实是同一根的两面——顺与逆、爱与恨、成与败，皆一体两面。看穿这层，便能在对立中保持从容。' },
        { title: '孔德之容', chapter: '第二十一章', source: '《道德经》', text: '孔德之容，惟道是从。', explain: '最大的德，其样貌完全随顺于道。人不必刻意表现德行，而是让行为自然流露于道的轨迹。修养到了深处，便没有了"我在修养"的痕迹。' },
        { title: '曲则全', chapter: '第二十二章', source: '《道德经》', text: '曲则全，枉则直，洼则盈，敝则新。', explain: '弯曲反而保全，委屈反而伸展，低洼反而充盈，破旧反而更新。这是最深刻的辩证法——表面上的"亏"，常常正是深层"盈"的开始。接受当下不完美的姿态，反而是走向完整的开始。' },
        { title: '希言自然', chapter: '第二十三章', source: '《道德经》', text: '希言自然。', explain: '少说话，合于自然。言语越多，距离本心越远。沉默不是无言，而是让真正该说的话得以清晰。少言，是一种高贵的克制。' },
        { title: '企者不立', chapter: '第二十四章', source: '《道德经》', text: '企者不立，跨者不行。', explain: '踮起脚跟站不稳，迈大步走不远。刻意求高求快，反而失去根基。自我提升是自然的积累，不是急切的跳跃。稳比快更重要。' },
        { title: '有物混成', chapter: '第二十五章', source: '《道德经》', text: '有物混成，先天地生。寂兮寥兮，独立而不改，周行而不殆。', explain: '在天地诞生之前，便有一个混然一体的东西存在。它寂静空旷，独立长存，循环运行，永不衰竭。这便是"道"的本体形象——无形无相，却是万物的源头。' },
        { title: '重为轻根', chapter: '第二十六章', source: '《道德经》', text: '重为轻根，静为躁君。', explain: '厚重是轻浮的根本，安静是躁动的主人。一个人若能守住内在的厚重与沉静，外在的浮华便不会动摇他。这是定力的本质。' },
        { title: '善行无辙迹', chapter: '第二十七章', source: '《道德经》', text: '善行无辙迹，善言无瑕谪。', explain: '高明的行为不留痕迹，高明的话语无可指摘。这不是教你如何隐藏，而是说最好的作为是顺势而为，自然而然，不留生硬的人为雕琢。' },
        { title: '知其雄守其雌', chapter: '第二十八章', source: '《道德经》', text: '知其雄，守其雌，为天下谿。', explain: '知道刚强，却安守柔弱；知道荣耀，却甘处卑下。这是反向的智慧——主动退到低处，反而能汇聚一切溪流。谦下者，最有力量。' },
        { title: '将欲取天下', chapter: '第二十九章', source: '《道德经》', text: '将欲取天下而为之，吾见其不得已。', explain: '想要靠强力来"治理"天下的人，我看他达不到目的。天下是活的、有机的，不是被塑造的对象。任何强行作为，都会激起相应的反作用。' },
        { title: '以道佐人主', chapter: '第三十章', source: '《道德经》', text: '以道佐人主者，不以兵强天下。', explain: '用道来辅佐君主的人，不会用武力逞强于天下。因为战争必有报应——哪里有强兵，哪里便有不祥之兆。真正高明的人，从不靠压迫成就事业。' },
        { title: '道常无为', chapter: '第三十七章', source: '《道德经》', text: '道常无为而无不为。', explain: '道永远是"无为"的，却成就了"无不为"。最高的效率不是忙乱，而是顺应规律后的自然成就。如水之就下，不费丝毫力气。' },
        { title: '上士闻道', chapter: '第四十一章', source: '《道德经》', text: '上士闻道，勤而行之；中士闻道，若存若亡；下士闻道，大笑之。', explain: '上等根器的人听到道，努力去践行；中等根器的人听了将信将疑；下等根器的人听了大笑——不笑不足以为道。这提醒我们：理解不了的东西，先别急着否定。' },
        { title: '出生入死', chapter: '第五十章', source: '《道德经》', text: '出生入死。生之徒十有三，死之徒十有三，人之生动之死地亦十有三。', explain: '人从生走向死，寿命长的占十分之三，寿命短的占十分之三，本来可以长寿却自找死路的也占十分之三。这是对生命无常的清醒提示——珍惜当下，亦警惕主动折损自己的选择。' }
      ],
      vajra: [
